      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <div className="mt-2 flex flex-wrap gap-2">
            <StatusBadge tone={bookingStatusTone(booking.bookingStatus)} dot>
              {statusLabel(booking.bookingStatus)}
            </StatusBadge>
            <StatusBadge tone={paymentStatusTone(booking.payment.status)}>
              {statusLabel(booking.payment.status)}
            </StatusBadge>
            <StatusBadge tone="accent">{booking.payment.method}</StatusBadge>
          </div>
        </div>
