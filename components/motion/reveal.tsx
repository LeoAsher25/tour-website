...
/** Scroll-linked vertical parallax — children drift slower than the page. */
export function Parallax({
  ...
  const { scrollYProgress } = useScroll({
    target: ref,
    offset: offset ?? (["start end", "end start"] as unknown as ScrollOffset),
  });
...
/** Cinematic zoom-out reveal — image starts enlarged and settles on scroll. */
